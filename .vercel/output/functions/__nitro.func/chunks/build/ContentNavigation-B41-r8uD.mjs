...
import { u as useAsyncData } from './asyncData-CnE4pWld.mjs';
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-D91iBxyH.mjs';
import { u as useContentPreview } from './preview-Clz1MhZH.mjs';
import { c as useState, e as useRuntimeConfig, a as __nuxt_component_0$1 } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-DYiBm0dK.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-B41-r8uD.mjs.map
