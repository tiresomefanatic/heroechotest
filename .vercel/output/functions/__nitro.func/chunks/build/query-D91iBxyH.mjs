import { w as withLeadingSlash, o as joinURL, t as withoutTrailingSlash, U as withBase, x as hash } from '../nitro/nitro.mjs';
import { e as useRuntimeConfig } from './server.mjs';
import { a as useRequestEvent } from './cookie-CUnBGDd5.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-DYiBm0dK.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-D91iBxyH.mjs.map
